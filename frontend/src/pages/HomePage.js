  ...
  <div className="min-h-screen bg-black text-white">
    <HeroHighlight>
      <div className="relative z-20 text-center px-4">
        <h1 className="text-4xl font-bold mt-12 mb-10">Trade Books Effortlessly</h1>
        <p className="text-lg mt-4 mb-8">
          Welcome to our Book Trading Platform <br></br> where you can easily swap books with a community of avid readers.
